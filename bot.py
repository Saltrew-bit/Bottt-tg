...
ADMIN_ID = 1688416529  # Telegram ID администратора
CHANNEL_ID = "@AutoHub62Channel"  # канал для публикации объявлений

bot = Bot(token=BOT_TOKEN)
dp = Dispatcher()

ads_data = {}  # временное хранение данных по пользователю
pending_ads = {}  # объявления, ожидающие модерацию
