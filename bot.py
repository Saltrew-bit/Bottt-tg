...
async def process_message(msg: types.Message):
    ...
    if step == 1:
        ...
        await msg.answer(
            "Если хотите, отправьте фото автомобиля (до 10). "
            "Когда закончите, напишите 'стоп'. Фото не обязательно."
        )
    elif step == 7:
        if msg.photo:
...
async def send_to_admin(user_id):
    ...
    await bot.send_message(user_id, "Ваше объявление приятно и отправлено на модерацию.")
