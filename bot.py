...
async def rules(callback: types.CallbackQuery):
    await callback.message.answer(
        ...
        "4. Краткое, но информативное описание\n"
    ...
    # Шаг 5: фото
        ...
        if msg.photo:
            ...
            if len(ad["photos"]) < 10:
                ...
                await msg.answer("Все фото получены. Введите контакт (например: @username или +7XXXXXXXXXX):")
