...
async def start(msg: types.Message):
    logging.info(f"/start от {msg.from_user.id} ({msg.from_user.full_name})")
...
@dp.message()
async def log_all(msg: types.Message):
    logging.info(f"Message from {msg.from_user.id}: {msg.text}")
